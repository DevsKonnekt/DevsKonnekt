  ...
  return (
    <div className="w-full h-screen sm:h-[50vh] lg:h-[75vh] flex flex-col justify-center items-center p-4 gap-4 relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full rounded-[75px] rounded-t-none flex flex-col items-center justify-center px-4 sm:px-8 md:px-12 pt-12 sm:pt-auto">
        <h1 className="text-3xl text-background font-bold text-center leading-10">
        ...
        <Link
          ...
          className="bg-background hover:bg-background/75 px-4 py-1 rounded-md transition-all duration-500 focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 focus:ring-offset-secondary hover:scale-105 w-full sm:w-auto flex items-center justify-center min-w-[280px] mt-8"
        >
          Find a Mentor
        </Link>
      </div>
