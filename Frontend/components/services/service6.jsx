...
function Services6() {
  return (
    <section className="bg-background dark:bg-gray-700 min-h-[370px] sm:h-[370px] flex flex-col gap-4 justify-between items-center mx-4 p-4 md:pt-0 md:px-12 md:flex-row mt-8 rounded-lg shadow-md shadow-secondary mb-8">
      ...
      <div className="flex-1 w-full flex flex-col justify-start">
        ...
        <p className="text-primary dark:text-background font-normal">
          Discover and attend coding workshops, hackathons, and tech meetups
          near you. Network with fellow developers and grow together.
        </p>
        <Link
